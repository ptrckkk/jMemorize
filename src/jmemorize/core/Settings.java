...
public class Settings
{
    ...
    private final static String OPEN_AUTOMATICALLY = "open-automatically"; //$NON-NLS-1$
    private final static String LAST_OPENED_FILE = "last-opened-file"; //$NON-NLS-1$
...
//            Main.logThrowable("failed to load font alignment.", e);
    ...
    public static void storeOpenLastFileAutomatically(boolean openAutomatically)
    {
        PREFS.putBoolean(OPEN_AUTOMATICALLY, openAutomatically);
    }
    ...
    /**
     * @return <code>true</code> if the last file that was opened, is to
     * be automatically when the application is opened the next time.
     */
    public static boolean loadOpenLastFileAutomatically()
    {
        return PREFS.getBoolean(OPEN_AUTOMATICALLY, false);
    }

    /**
     * @return Returns the path to the last opened file.
     */
    public static String loadLastOpenedPath()
    {
        return PREFS.get(LAST_OPENED_FILE, "");
    }

    public static void storeLastOpenedPath(String lastOpenedPath)
    {
        PREFS.put(LAST_OPENED_FILE, lastOpenedPath);
    }
